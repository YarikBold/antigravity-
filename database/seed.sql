-- Antigravity Seed [2] — детерминированные UUID для 2 профилей
...
INSERT INTO workout_plans (id, name, target_user_id, split_type, description) VALUES
  ...
  ('00000000-0000-0000-0000-000000000011', 'Full Body — Reboot', '00000000-0000-0000-0000-000000000001', 'full_body', 'Spec alias для 000...001'),
  ('00000000-0000-0000-0000-000000000022', 'Upper/Lower — Shape', '00000000-0000-0000-0000-000000000002', 'upper_lower', 'Spec alias для 000...002')
ON CONFLICT (id) DO NOTHING;

-- Plan 333 (Reboot) 3 дня
